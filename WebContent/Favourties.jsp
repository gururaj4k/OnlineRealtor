...
<form action="favourites" method="post">
		<h2><u>Your Favourite List</u> </h2>
				<%RealtorManager realtorMngr=new RealtorManager(); %>
				<% UserDetails user= (UserDetails)session.getAttribute("userContext");%>
			<%List<Assets> assests1 = realtorMngr.getUserFavourites(user.getUserId());%>
			<%int propertyCount=1;%>
 ...
 <tr >
                <td>
                    <table border="0" >
                        <tr>
                            <td colspan="2">
                               <b><u> Property <%out.println(propertyCount);%></u> </b>:
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                               <%out.println(o.getAddressline1()); %>, <%out.println(o.getAddressline2()); %>
                            </td>
                            <td align="right">
                                <b> Price :</b>
                            </td>
